...
1. Какой IP-адрес и номер порта TCP использует ваш компьютер (отправитель), передающий
   ...
   - 192.168.0.111, 5324
![image](https://github.com/ulyabelyaeva/networks-course/assets/83698888/0261fb7f-2a1a-493a-a7f4-f8068c294ab4)
...
3. Какой порядковый номер у SYN TCP-сегмента, который используется для установления
   ...
   - 0
   - выставлен соответствующий бит в заголовке Flags
![image](https://github.com/ulyabelyaeva/networks-course/assets/83698888/e5399afe-4eea-4ec7-ac72-5b8b4ed0e35d)
...
4. Какой порядковый номер у SYNACK-сегмента, отправленного сервером gaia.cs.umass.edu
   ...
   - выставлены два соответствующих бита в заголовке Flags
5. Какой порядковый номер у TCP-сегмента, содержащего команду POST протокола HTTP?
   ...
   - 1
![image](https://github.com/ulyabelyaeva/networks-course/assets/83698888/188afbd3-1863-40b7-9afc-2e99286b4877)
...
6. Рассмотрите TCP-сегмент, содержащий команду POST протокола HTTP, как первый TCP-сегмент 
   ...
   - 1, 1461, 2921, 4381, ...
   -  Первая партия пакетов была послана на 116мс, ответ на 1-10 сегменты пришел на 238 мс. За 122 мс было передано 13144 байт. Примерная скорость 105кБ/с.
![image](https://github.com/ulyabelyaeva/networks-course/assets/83698888/aa41185d-a619-40b2-ad8d-1a36cc84b250)
...
#### Скрин
<img width="1121" alt="image" src="https://github.com/ulyabelyaeva/networks-course/assets/83698888/f3c5ce9a-f6c7-4a27-9d86-d94dd29722b3">
