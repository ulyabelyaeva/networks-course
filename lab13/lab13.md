...
1. Поверх какого протокола посылаются сообщения DHCP – UDP или TCP?
   - UDP
![image](https://github.com/ulyabelyaeva/networks-course/assets/83698888/9298c18f-900e-4fc6-816b-37eb9b29c945)
2. Каков адрес канального уровня (т.е., Ethernet-адрес) у вашего хоста?
   - c0:38:96:6b:b2:5f
![image](https://github.com/ulyabelyaeva/networks-course/assets/83698888/4bfa96d2-b065-4514-aa36-33a554289b66)
3. Каковы значения Transaction-ID в наборе (Request/ACK) DHCP-сообщений? Опишите
   назначение поля Transaction-ID.
   - 0x06aaacf1 -- идентификатор транзакции, который позволяет отличать данный процесс получения IP-адреса от других, протекающих в то же время.
![image](https://github.com/ulyabelyaeva/networks-course/assets/83698888/0169522a-bbdf-4c80-9104-ed8057a8198c)
...
![image](https://github.com/ulyabelyaeva/networks-course/assets/83698888/110f079a-b600-48ac-9045-01f45c18f7a0)
5. Каков IP-адрес вашего DHCP-сервера?
   - 192.168.0.1
6. Объясните назначение срока аренды IP-адреса. Какова длительность срока аренды в
   вашем эксперименте?
   - 1 день
![image](https://github.com/ulyabelyaeva/networks-course/assets/83698888/9e34d59b-e973-4846-8a24-a3c99b49ccc8)
...
![image](https://github.com/ulyabelyaeva/networks-course/assets/83698888/74bf5fd9-0b59-470d-ba0c-178e0ea41257)
